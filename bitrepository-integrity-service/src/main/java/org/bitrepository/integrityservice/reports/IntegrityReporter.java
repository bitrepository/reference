...
public interface IntegrityReporter {
     ...
     *
     * @throws IOException Throws an IOException if any error occur.
     */
    ...
    /**
     * Report that a file has been deleted from the collection. Note this is not considered an integrity issue.
     *
     ...
     */
    void reportDeletedFile(String pillarID, String fileID) throws IOException;
