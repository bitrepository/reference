...
public class BasicIntegrityReporter implements IntegrityReporter {
    ...
    private static final DateTimeFormatter FS_DATE_FORMAT = DateTimeFormatter.ofPattern("yyyyMMdd-HHmmss", Locale.ROOT)
            .withZone(ZoneId.systemDefault());
    private static final DateTimeFormatter REPORT_DATE_FORMAT = DateTimeFormatter.ofPattern("yyyy/MM/dd HH:mm:ss", Locale.ROOT)
            .withZone(ZoneId.systemDefault());
    ...
    public BasicIntegrityReporter(String collectionID, String workflowType, File reportsDir) {
        ...
        reportDir = new File(collectionReportsDir, FS_DATE_FORMAT.format(reportDate));
        reportDir.mkdir();
    ...
    public void generateReport() throws IOException {
        String generatedDate = REPORT_DATE_FORMAT.format(Instant.now());
