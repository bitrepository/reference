...
public interface IntegrityInformationCollector {
     ...
     */
    void getFileIDs(String collectionID, Collection<String> pillarIDs, String auditTrailInformation, ContributorQuery[] queries,
     ...
     * @param auditTrailInformation The audit trail information for the conversation.
     */
    void getFile(String collectionID, String fileId, URL uploadUrl, EventHandler eventHandler, String auditTrailInformation);
     ...
     * @param auditTrailInformation  The audit trail information for the conversation.
     */
    void putFile(String collectionID, String fileId, URL uploadUrl, ChecksumDataForFileTYPE checksumValidationData,
