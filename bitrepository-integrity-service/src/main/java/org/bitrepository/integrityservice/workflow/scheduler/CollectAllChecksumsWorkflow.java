...
public class CollectAllChecksumsWorkflow extends IntervalWorkflow {
     ...
     */
    public CollectAllChecksumsWorkflow(long interval, String name, ChecksumSpecTYPE checksumType, 
            Settings settings, IntegrityInformationCollector informationCollector, EventHandler eventHandler) {
        super(interval, name);
