...
public class GetChecksumForFileStep extends AbstractWorkFlowStep {
     ...
     */
    public GetChecksumForFileStep(IntegrityInformationCollector collector, IntegrityAlerter alerter, ChecksumSpecTYPE checksumType,
                                  String fileID, Settings settings, String collectionID, IntegrityContributors integrityContributors) {
