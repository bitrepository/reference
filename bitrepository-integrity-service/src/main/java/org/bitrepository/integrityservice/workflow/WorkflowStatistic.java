...
/**
 * Provides details about the statistics of a workflow. The statistics will not be fully populated until the
...
public class WorkflowStatistic {
    ...
    /**
     * Marks the start time of a sub step of the statistics.
     *
     * @param name The name of the sub-step to be used as identifier in the statistics.
     */
    ...
    /**
     * Marks the end time of a sub step of the statistics.
     */
    ...
    /**
     * @return A string representation of statistics, including all sub-statistics.
     */
    public String getFullStatistics() {
        ...
        sb.append(getName()).append(" duration: ").append(TimeUtils.millisecondsToHuman(getDuration()));
        for (WorkflowStatistic stepStat : subStatistics) {
            sb.append(LINEFEED).append(stepStat.getFullStatistics());
        }
        return sb.toString();
    }
    ...
    public String getPartStatistics() {
        if (start == null) {
            ...
            return currentSubStatistic.getName() + LINEFEED + "Running for " +
                    TimeUtils.millisecondsToHuman(currentSubStatistic.getDuration()) + "/" + TimeUtils.millisecondsToHuman(getDuration()) +
                    ")";
        }
    }
    ...
    public String toString() {
        return "WorkflowStatistic{" + "name='" + name + '\'' + ", start=" + start + ", finish=" + finish + ", subStatistics=" +
                subStatistics + '}';
    }
}
