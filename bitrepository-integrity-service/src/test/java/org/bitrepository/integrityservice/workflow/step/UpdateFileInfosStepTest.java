...
public class UpdateFileInfosStepTest extends WorkflowstepTest {
    ...
    public void testPositiveReply() throws WorkflowAbortedException {
        ...
        step.performStep();
        verify(collector).getFileInfos(eq(TEST_COLLECTION), Matchers.<Collection<String>>any(), any(ChecksumSpecTYPE.class), 
    ...
    public void testAbortWorkflowWhenNegativeReply() {
        addDescription("Test the step for updating the fileinfos will abort the workflow in case "
        ...
        verify(collector).getFileInfos(eq(TEST_COLLECTION), Matchers.<Collection<String>>any(), any(ChecksumSpecTYPE.class), anyString(), 
                anyString(), any(ContributorQuery[].class), any(EventHandler.class));
    ...
    public void testRetryCollectionWhenNegativeReply() throws WorkflowAbortedException {
        addDescription("Test the step for updating the fileinfos will retry on a FAILED event");
    ...
    public void testFullFileInfoCollection() throws WorkflowAbortedException {
        addDescription("Test that the full list of fileinfos is requested.");
