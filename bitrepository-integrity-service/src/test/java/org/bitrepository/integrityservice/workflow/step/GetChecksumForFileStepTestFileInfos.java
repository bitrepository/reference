 ...
 */
public class GetChecksumForFileStepTestFileInfos extends WorkflowstepTest {
    ...
    public void testFullData() throws Exception {
        ...
        doAnswer(invocation -> {
            ...
            eventHandler.handleEvent(new FileInfosCompletePillarEvent(TEST_PILLAR_1, TEST_COLLECTION, res,
                    (ChecksumSpecTYPE) invocation.getArguments()[2], false));
            eventHandler.handleEvent(new FileInfosCompletePillarEvent(TEST_PILLAR_2, TEST_COLLECTION, res,
                    (ChecksumSpecTYPE) invocation.getArguments()[2], false));
            eventHandler.handleEvent(new FileInfosCompletePillarEvent(TEST_PILLAR_3, TEST_COLLECTION, res,
                    (ChecksumSpecTYPE) invocation.getArguments()[2], false));
            eventHandler.handleEvent(new CompleteEvent(TEST_COLLECTION, null));
            return null;
        }).when(collector).getFileInfos(eq(TEST_COLLECTION), anyCollection(), any(ChecksumSpecTYPE.class), anyString(),
    ...
    public void testComponentFailure() throws Exception {
        ...
        doAnswer(invocation -> {
            ...
            ResultingFileInfos res = createResultingFileInfos((String) invocation.getArguments()[3], "checksum");
            ContributorEvent e1 = new FileInfosCompletePillarEvent(TEST_PILLAR_1, TEST_COLLECTION, res,
                    (ChecksumSpecTYPE) invocation.getArguments()[2], false);
            ContributorEvent e2 = new FileInfosCompletePillarEvent(TEST_PILLAR_2, TEST_COLLECTION, res,
                    (ChecksumSpecTYPE) invocation.getArguments()[2], false);
            ContributorEvent e3 = new ContributorFailedEvent(TEST_PILLAR_3, TEST_COLLECTION,
