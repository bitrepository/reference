...
public class SetUnknownFilesToMissingStepTest extends ExtendedTestCase {
    ...
    public void testUpdatingEmptyStore() {
        ...
        SetUnknownFilesToMissingStep step = new SetUnknownFilesToMissingStep(store);
    ...
    public void testUpdatingExistingFiles() {
        ...
        SetUnknownFilesToMissingStep step = new SetUnknownFilesToMissingStep(store);
        Assert.assertEquals(store.getCallsForSetUnknownFilesToMissing(), 0);
