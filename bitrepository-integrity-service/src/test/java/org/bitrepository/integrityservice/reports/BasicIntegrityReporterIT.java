...
public class BasicIntegrityReporterIT extends IntegrationTest {
    ...
    public void deletedFilesTest() throws Exception {
        ...
        Assertions.assertFalse(reporter.hasIntegrityIssues(),
                "Reporter interpreted delete file as a integrity issue");
    ...
    public void noIntegrityIssuesTest() {
        ...
        addStep("Create a clean reporter",
    ...
    public void missingFilesTest() throws Exception {
        ...
        addStep("Report another missing file on the same pillar",
    ...
    public void checksumIssuesTest() throws Exception {
        ...
        addStep("Report a checksum issue",
        ...
        addStep("Report another checksum issue on the same pillar",
                "The summary report should be update with the " +
    ...
    public void missingChecksumTest() throws Exception {
        ...
        addStep("Report a missing checksum",
                "hasIntegrityIssues() should return true and the summary report should " +
        ...
        addStep("Report another missing checksum on the same pillar",
                "The summary report should be update with the " +
    ...
    public void obsoleteChecksumTest() throws Exception {
        ...
        addStep("Report a obsolete checksum",
                "hasIntegrityIssues() should return true and the summary report should " +
                        "correctly inform of the obsolete checksum.");
        BasicIntegrityReporter reporter =
                new BasicIntegrityReporter("CollectionWithIssues",
                        "test", new File("target/"));
        reporter.reportObsoleteChecksum("TestChecksum", "Pillar1");
        Assertions.assertTrue(reporter.hasIntegrityIssues(),
                "Reporter didn't interpreted obsolete checksum as a integrity issue");
        String expectedReport = REPORT_SUMMARY_START + "Pillar1 has 1 obsolete checksum.";
        Assertions.assertEquals(expectedReport, reporter.generateSummaryOfReport());

        addStep("Report another obsolete checksum on the same pillar",
                "The summary report should be update with the " +
        ...
        expectedReport =
                REPORT_SUMMARY_START + "Pillar1 has 2 obsolete checksums." + "\nPillar2 has 1 obsolete checksum.";
        Assertions.assertEquals(expectedReport, reporter.generateSummaryOfReport());
    }
}
