...
class ExampleReportGenerationTest {
    ...
    @Test
    void generateExampleReport() throws IOException {
        IntegrityReporter reporter =
                new BasicIntegrityReporter("dummy-collection", "test-class", new File("target/"));
    ...
    @Test
    void generateEmptyReport() throws IOException {
        IntegrityReporter reporter =
                new BasicIntegrityReporter("dummy-collection", "test-class", new File("target/"));
        reporter.generateReport();
        printReport(reporter.getReport());
