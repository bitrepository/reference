...
public final class AuditDatabaseConstants {
     ...
     */
    public final static String AUDIT_TRAIL_KEY = "audit_key";
    /**
     ...
     */
    public final static String AUDIT_TRAIL_CONTRIBUTOR_KEY = "contributor_key";
    /**
     * The name of the file key field in the audit trail table.
     */
    public final static String AUDIT_TRAIL_FILE_KEY = "file_key";
    /**
     * The name of the actor key field in the audit trail table.
     */
    public final static String AUDIT_TRAIL_ACTOR_KEY = "actor_key";
    /**
     ...
     */
    public final static String AUDIT_TRAIL_OPERATION_ID = "operationID";
    /**
