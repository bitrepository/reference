...
public class AlarmDatabaseMigrator extends DatabaseMigrator {
    ...
    private final Integer currentDatabaseVersion = 4;
    ...
    public void migrate() {
        ...
        if (versions.get(ALARM_DATABASE_VERSION_ENTRY) < 4) {
            log.warn("Migrating AlarmServiceDB from version 3 to 4.");
    ...
    public boolean needsMigration() {
        ...
        } else return versions.get(ALARM_TABLE_VERSION_ENTRY) < currentDatabaseVersion;
    }
}
