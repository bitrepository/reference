...
import org.bitrepository.pillar.conversation.PillarMediator;
...
//    private final IntegrationConfiguration config;
    ...
    ReferencePillarMessageFactory msgFactory;

    public ReferencePillar(MessageBus mBus, PillarSettings settings) {
        this.bus = mBus;
        this.settings = settings;
//        this.config = iConfig;
        msgFactory = new ReferencePillarMessageFactory(settings);
...
//     * Constructor.
//     */
//    public ReferencePillar(MessageBus mBus, IntegrationConfiguration iConfig) throws Exception {
//        // TODO use settings.
//        this.config = iConfig;
//        this.pillarId = iConfig.getPillarId();
//        this.collectionId = iConfig.getBitrepositoryCollectionId();
//        this.slaIds = new ArrayList<String>();
//        slaIds.add(collectionId);
