 ...
 * /bitrepository/pillar/PillarTestMessageFactory.java $
 * %%
...
public class GetFileInfosMessageFactory extends PillarTestMessageFactory {
    public GetFileInfosMessageFactory(String collectionID, Settings clientSettings, String pillarID, String pillarDestination) {
        super(collectionID, clientSettings, pillarID, pillarDestination);
    }

    public IdentifyPillarsForGetFileInfosRequest createIdentifyPillarsForGetFileInfosRequest(ChecksumSpecTYPE csSpec, FileIDs fileID) {
    ...
    public GetFileInfosRequest createGetFileInfosRequest(ChecksumSpecTYPE csSpec, FileIDs fileID, String url, Long maxResults,
                                                         XMLGregorianCalendar maxChecksumDate, XMLGregorianCalendar minChecksumDate,
                                                         XMLGregorianCalendar maxFileDate, XMLGregorianCalendar minFileDate) {
