...
public abstract class DefaultPillarIT extends DefaultFixturePillarIT {
    ...
    protected void initializeCUT() {
        super.initializeCUT();
        collectionID = settingsForTestClient.getCollections().getFirst().getID();
        File fileDir = new File(settingsForCUT.getReferenceSettings()
                                              .getPillarSettings()
                                              .getCollectionDirs()
                                              .getFirst()
                                              .getFileDirs()
