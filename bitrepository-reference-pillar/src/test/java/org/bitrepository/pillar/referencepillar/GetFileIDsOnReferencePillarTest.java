...
public class GetFileIDsOnReferencePillarTest extends ReferencePillarTest {
    ...
    public void pillarGetFileIDsTestSuccessCase() throws Exception {
        ...
        IdentifyPillarsForGetFileIDsRequest identifyRequest = msgFactory.createIdentifyPillarsForGetFileIDsRequest(
                DEFAULT_UPLOAD_FILE_ADDRESS, FileIDsUtils.createFileIDs(DEFAULT_FILE_ID), getPillarID(), clientDestinationId);
        ...
        GetFileIDsRequest getFileIDsRequest = msgFactory.createGetFileIDsRequest(
                DEFAULT_DOWNLOAD_FILE_ADDRESS, receivedIdentifyResponse.getCorrelationID(),
                FileIDsUtils.createFileIDs(DEFAULT_FILE_ID), getPillarID(), getPillarID(),
    ...
    public void pillarGetFileIDsTestSuccessCaseAllFilesAndURL() throws Exception {
        ...
        IdentifyPillarsForGetFileIDsRequest identifyRequest = msgFactory.createIdentifyPillarsForGetFileIDsRequest(
                DEFAULT_AUDITINFORMATION, FileIDsUtils.createFileIDs(DEFAULT_FILE_ID), getPillarID(),
                clientDestinationId);
        messageBus.sendMessage(identifyRequest);
    ...
    public void pillarGetFileIDsTestFailedNoSuchFile() throws Exception {
        addDescription("Tests that the ReferencePillar is able to reject a GetFileIDs requests for a file, which it " +
                "does not have.");
