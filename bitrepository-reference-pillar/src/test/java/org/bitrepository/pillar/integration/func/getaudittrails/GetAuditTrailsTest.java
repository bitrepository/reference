...
class GetAuditTrailsTest extends PillarFunctionTest {
    @Override
    ...
    @Tag(PillarTestGroups.FULL_PILLAR_TEST)
    @Tag(PillarTestGroups.CHECKSUM_PILLAR_TEST)
    void eventSortingTest() throws NegativeResponseException {
