...
public abstract class DefaultPillarIdentificationIT extends DefaultPillarMessagingIT {
    ...
    public void irrelevantCollectionTest() {
        ...
        addStep("Sending a putFile identification with a irrelevant collectionID. i.e. the " +
    ...
    @Override protected ResponseCode expectedResponseCodeForRequest() {
        return ResponseCode.IDENTIFICATION_POSITIVE;
    }
}
