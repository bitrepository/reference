...
class GetFileIDsIT extends DefaultPillarOperationIT {
    ...
    void pillarGetFileIDsTestSuccessCase() throws Exception {
        ...
        GetFileIDsProgressResponse progressResponse = clientReceiver.waitForMessage(GetFileIDsProgressResponse.class,
                getOperationTimeout(), TimeUnit.SECONDS, getFileIDsRequest.getCorrelationID());
        ...
        GetFileIDsFinalResponse finalResponse = receiveResponse(getFileIDsRequest);
    ...
    void pillarGetFileIDsTestBadDeliveryURL() throws Exception {
        ...
        String badURL = "http://localhost:54321/¾";
        GetFileIDsRequest getFileIDsRequest = msgFactory.createGetFileIDsRequest(
    ...
    @Override
    protected GetFileIDsFinalResponse receiveResponse(MessageRequest request) {
    ...
    public String lookupPillarDestination() {
        IdentifyPillarsForGetFileIDsRequest identifyPillarsForGetFileIDsRequest = msgFactory.createIdentifyPillarsForGetFileIDsRequest(null);
        messageBus.sendMessage(identifyPillarsForGetFileIDsRequest);
        return clientReceiver.waitForMessage(IdentifyPillarsForGetFileIDsResponse.class, identifyPillarsForGetFileIDsRequest.getCorrelationID()).getReplyTo();
    }
}
