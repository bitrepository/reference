...
public class CollectionTestHelper {
    ...
    public CollectionTestHelper(
        ...
        GetFileIDsClient getFileIDsClient = AccessComponentFactory.getInstance().createGetFileIDsClient(
                settings, securityManager, settings.getComponentID()
        );
        DeleteFileClient deleteFileClient = ModifyComponentFactory.getInstance().retrieveDeleteFileClient(
                settings, securityManager, settings.getComponentID()
        );
    }
