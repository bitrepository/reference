...
public class GetFileIDsQueryTest extends PillarFunctionTest {
    ...
    public void minTimeStampTest() {
        ...
        XMLGregorianCalendar newestTimestamp =
                originalFileIDsList.get(originalFileIDsList.size() - 1).getLastModificationTime();
        ...
        Assertions.assertEquals(0, limitedFileIDsList.get(0).getLastModificationTime().compare(newestTimestamp),
    ...
    public void maxTimeStampTest() {
        ...
        Assertions.assertEquals(0, limitedFileIDsList.get(0).getLastModificationTime().compare(oldestTimestamp),
