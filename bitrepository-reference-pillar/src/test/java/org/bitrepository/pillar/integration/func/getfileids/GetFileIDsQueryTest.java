...
public class GetFileIDsQueryTest extends PillarFunctionTest {
    ...
    public void minTimeStampTest() {
        ...
        addStep("Request file ids with MinTimeStamp set to the timestamp of the newest file id + 1 ms",
    ...
    public void maxTimeStampTest() {
        ...
        limitedFileIDsList = pillarFileManager.getFileIDs(query);
        Assert.assertFalse(limitedFileIDsList.isEmpty(), "At least one file id with the oldest timestamp should be returned.");
        ...
        addStep("Request file ids with MaxTimeStamp set to the timestamp of the oldest file id - 1 ms",
                "No file ids are returned.");
        ...
        limitedFileIDsList = pillarFileManager.getFileIDs(query);
        Assert.assertTrue(limitedFileIDsList.isEmpty(),
                "Not empty file id list returned with olderThanOldestTimestamp query: " + limitedFileIDsList.size());
    }          
}
