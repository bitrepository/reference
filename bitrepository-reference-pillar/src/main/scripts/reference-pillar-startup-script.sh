...
export SSL_DEPENDENCIES="-Djavax.net.ssl.keyStore=conf/refpillar.ks -Djavax.net.ssl.keyStorePassword=123456 -Djavax.net.ssl.trustStore=conf/refpillar.ks -Djavax.net.ssl.trustStorePassword=123456"

# Launch the application
java -cp $CLASSPATH $SSL_DEPENDENCIES org.bitrepository.pillar.ReferencePillarLauncher . $PWD/conf
