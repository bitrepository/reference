...
echo java -cp $CLASSPATH $LOGBACK org.bitrepository.pillar.referencepillar.ReferencePillarLauncher $PWD/conf $KEYFILE 
java -cp $CLASSPATH $LOGBACK org.bitrepository.pillar.referencepillar.ReferencePillarLauncher $PWD/conf $KEYFILE > ReferencePillar.start 2>&1 &
