...
public class IdentifyPillarsForGetFileInfosRequestHandler
     ...
     */
    protected IdentifyPillarsForGetFileInfosRequestHandler(MessageHandlerContext context, StorageModel model) {
        super(context, model);
    }
    ...
    @Override
    public Class<IdentifyPillarsForGetFileInfosRequest> getRequestClass() {
        return IdentifyPillarsForGetFileInfosRequest.class;
    }
     ...
     */
    private IdentifyPillarsForGetFileInfosResponse createFinalResponse(IdentifyPillarsForGetFileInfosRequest msg) {
        IdentifyPillarsForGetFileInfosResponse res = new IdentifyPillarsForGetFileInfosResponse();
