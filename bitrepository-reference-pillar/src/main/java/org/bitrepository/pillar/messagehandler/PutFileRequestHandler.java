 ...
 * /bitrepository/pillar/messagehandler/PutFileRequestHandler.java $
 * %%
...
public class PutFileRequestHandler extends PerformRequestHandler<PutFileRequest> {
     ...
     * @throws InvalidMessageException If the file already exists.
     */
    private void checkThatTheFileDoesNotAlreadyExist(PutFileRequest message) throws InvalidMessageException {
    ...
    /**
     * Validates that enough space exists is left in the archive.<br>
     * If no size is defined in the message, then it is not checked.
     *
     ...
     * @throws RequestHandlerException If the retrieval of the file fails.
     */
