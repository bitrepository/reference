...
public class IdentifyContributorsForGetStatusRequestHandler 
        extends PillarMessageHandler<IdentifyContributorsForGetStatusRequest> {
    /** The log.*/
     ...
     */
    public IdentifyContributorsForGetStatusRequestHandler(PillarContext context) {
        super(context);
    }

    @Override
    public void handleMessage(IdentifyContributorsForGetStatusRequest message) {
        ArgumentValidator.checkNotNull(message, "IdentifyContributorsForGetStatusRequest message");
