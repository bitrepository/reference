...
public class ChecksumIngestor {
    ...
    public synchronized void insertNewEntry(String fileID, String collectionID, String checksum, Date date) {
        String sql = "INSERT INTO " + DatabaseConstants.CHECKSUM_TABLE + " ( " + DatabaseConstants.CS_FILE_ID + " , " 
    ...
    public void updateEntry(String fileID, String collectionID, String checksum, Date date) {
        String sql = "UPDATE " + DatabaseConstants.CHECKSUM_TABLE + " SET " + DatabaseConstants.CS_CHECKSUM 
                + " = ? , " + DatabaseConstants.CS_DATE + " = ? WHERE " + DatabaseConstants.CS_FILE_ID + " = ? AND " 
    ...
    public void removeEntry(String fileID, String collectionID) {
        String sql = "DELETE FROM " + DatabaseConstants.CHECKSUM_TABLE + " WHERE " + DatabaseConstants.CS_FILE_ID 
                + " = ? AND " + DatabaseConstants.CS_COLLECTION_ID + " = ?";
