...
public abstract class StorageModel {
     ...
     * The Full ReferencePillar will re-calculated the default checksum for the file and updated in the database, along
     ...
     * @param collectionID The id of the collection of the file.
     * @param csType       The type of checksum.
     * @return The {@link ChecksumEntry} for the requested type of checksum for the given file.
     * @throws RequestHandlerException If an error occurs when trying to compute a non-default checksum.
     */
     ...
     */
    public void verifyChecksumAlgorithm(ChecksumSpecTYPE checksumSpec) throws RequestHandlerException {
     ...
     *                                 ChecksumPillar).
     */
    protected ChecksumEntry retrieveNonDefaultChecksumEntry(String fileID, String collectionID, ChecksumSpecTYPE csType)
            throws RequestHandlerException {
        String checksum = getNonDefaultChecksum(fileID, collectionID, csType);
        return new ChecksumEntry(fileID, checksum, new Date());
    }
     ...
     */
    public abstract FileInfosDataItem getFileInfosDataItemFromChecksumDataItem(ChecksumDataForChecksumSpecTYPE cs, String collectionID);
