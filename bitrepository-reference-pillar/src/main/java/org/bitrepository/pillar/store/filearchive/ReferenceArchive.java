...
public class ReferenceArchive {
    ...
    /**
     * Retrieves an input-stream to the given file.
     *
     * @param fileID The id of the file.
     * @return The input-stream to the file.
     * @throws IOException If no input-stream can be made.
     */
    ...
    /**
     * Creates a file from the data in the input-stream.
     ...
     * @param inputStream The input-stream to extract the content of the file from.
