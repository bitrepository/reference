...
/**
 * AuditTrailContributorDAO which knows how to ask Derby to limit the number of results returned.
 */
public class DerbyAuditTrailContributorDAO extends AuditTrailContributorDAO {
