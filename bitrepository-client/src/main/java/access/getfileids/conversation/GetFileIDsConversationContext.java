...
public class GetFileIDsConversationContext extends ConversationContext {
     ...
     * {@link access.getfileids.GetFileIDsClient} specific parameters.
     * @param contributorQueries See {@link access.getfileids.GetFileIDsClient} for details.
     * @param urlForResult See {@link access.getfileids.GetFileIDsClient} for details.
     */
