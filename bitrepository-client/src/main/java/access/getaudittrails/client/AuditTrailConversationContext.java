...
/**
 * models the conversation context for the {@link access.getaudittrails.AuditTrailClient}
 */
public class AuditTrailConversationContext extends ConversationContext {
    ...
    /**
     * Extends the {@link ConversationContext} constructor with {@link access.getaudittrails.AuditTrailClient} specific parameters
     */
