...
/**
 * Wraps a <code>DeleteFileClient</code> to provide a blocking client. The client will block until the DeleteFileOperation
 * has finished.
 */
public class BlockingDeleteFileClient {
     ...
     */
    public List<ContributorEvent> deleteFile(String collectionID, String fileID, String pillarID,
        ...
        client.deleteFile(collectionID, fileID, pillarID, checksumForValidationAtPillar, checksumRequestsForValidation, blocker,
