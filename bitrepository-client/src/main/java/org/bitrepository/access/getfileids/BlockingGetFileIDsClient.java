...
public class BlockingGetFileIDsClient {
     ...
     */
    public List<ContributorEvent> getGetFileIDs(String collectionID, ContributorQuery[] contributorQueries, String fileID,
                                                URL addressForResult, EventHandler eventHandler) throws NegativeResponseException {
