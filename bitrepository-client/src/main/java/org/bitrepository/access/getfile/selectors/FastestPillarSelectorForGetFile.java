...
/**
 * GetFile specific selector for situations where the GetFile method can choose between multiple pillars. The selector will
 * choose the pillar able to return the file fastest, i.e. where the <cod>timeToDeliver</cod> ID is the smallest.
 */
