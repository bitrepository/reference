...
public class GetFileInfosConversationContext extends ConversationContext {
     ...
     * {@link org.bitrepository.access.getchecksums.GetFileInfosClient} specific parameters.
     * @param collectionID The ID of the collection
     * @param contributorQueries See {@link org.bitrepository.access.getchecksums.GetFileInfosClient} for details.
     * @param fileID The ID of the file to get checksums for
     * @param checksumSpec See {@link org.bitrepository.access.getchecksums.GetFileInfosClient} for details.
     * @param urlForResult See {@link org.bitrepository.access.getchecksums.GetFileInfosClient} for details.
