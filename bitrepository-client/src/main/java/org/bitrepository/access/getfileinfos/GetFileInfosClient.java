...
/**
 * Used for retrieving fileinfos for files stored on the collection pillars.
 */
public interface GetFileInfosClient extends BitrepositoryClient {

    /**
     * Retrieves the fileinfos for a set of files.
     * <p>
     ...
     * <p>
     * Since every pillar cannot upload their fileinfos to the same URL, it is extended with the pillarID for the given
     ...
     * pillars.
     * @param collectionID Identifies the collection to request fileinfos for.
     ...
     * @param addressForResult [OPTIONAL] The address to upload the resulting fileinfos to. If this is null, then the
