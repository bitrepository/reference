...
/**
 * Used for retrieving file-infos for files stored on the collection pillars.
 */
public interface GetFileInfosClient extends BitRepositoryClient {
     ...
     * @param addressForResult      [OPTIONAL] The address to upload the resulting file-infos to. If this is null, then the
     ...
     * @param auditTrailInformation Audit trail information for the contributors
     */
    void getFileInfos(String collectionID, ContributorQuery[] contributorQueries, String fileID,
