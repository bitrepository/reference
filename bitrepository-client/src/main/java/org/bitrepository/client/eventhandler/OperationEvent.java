...
public interface OperationEvent {
     ...
     * <li>TimeOut: The operation didn't finish before a timeout occurred.
     * </ol>
     */
    enum OperationEventType {
        IDENTIFY_REQUEST_SENT, COMPONENT_IDENTIFIED, IDENTIFICATION_COMPLETE, REQUEST_SENT, PROGRESS, COMPONENT_COMPLETE, COMPLETE,
        COMPONENT_FAILED, FAILED, IDENTIFY_TIMEOUT, WARNING
    }
