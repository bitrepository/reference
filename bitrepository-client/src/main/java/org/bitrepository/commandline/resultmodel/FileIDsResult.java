...
public class FileIDsResult {
    ...
    /**
     * Updates the filesize of the file, if the filesize does not match, mark it as an unknown
     *
     ...
     *
     * @return the size of the file, or null if unknown or -1 if there are filesize conflicts between contributors
     */
