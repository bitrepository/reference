...
import static org.bitrepository.common.utils.AllureTestUtils.addReference;
import static org.bitrepository.common.utils.AllureTestUtils.addStep;

@ExtendWith(SuiteInfoParameterResolver.class)
public class PutFileClientComponentIT extends DefaultFixtureClientIT {
    ...
    public void noPillarsResponding() throws Exception {
        ...
        addFixture("Sets the identification timeout to 1000 ms.");
    ...
    public void onePillarRespondingWithPartialPutAllowed() throws Exception {
        ...
        Allure.step("Fixture: Set identification timeout to 2000 ms and allow partial puts.", () -> {
            settingsForCUT.getRepositorySettings().getClientSettings()
    ...
    public void onePillarRespondingWithPartialPutDisallowed() throws Exception {
        ...
        addFixture("Sets the identification timeout to 2000 ms and disallow partial puts.");
    ...
    public void putClientOperationTimeout() throws Exception {
        ...
        IdentifyPillarsForPutFileResponse identifyResponse = messageFactory
                .createIdentifyPillarsForPutFileResponse(
                        receivedIdentifyRequestMessage, PILLAR1_ID, pillar1DestinationId);
        messageBus.sendMessage(identifyResponse);
        pillar1Receiver.waitForMessage(PutFileRequest.class, 10, TimeUnit.SECONDS, identifyResponse.getCorrelationID());
    ...
    public void putClientPillarOperationFailed() throws Exception {
        ...
        PutFileRequest receivedPutFileRequest =
                pillar1Receiver.waitForMessage(PutFileRequest.class, 10, TimeUnit.SECONDS,
                                               identifyResponse.getCorrelationID());
