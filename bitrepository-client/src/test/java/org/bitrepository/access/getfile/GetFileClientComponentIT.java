...
class GetFileClientComponentIT extends AbstractGetFileClientIT {
    ...
    void getFileFromSpecificPillar() throws Exception {
        ...
        addStep("Send a response from pillar1", "Should be ignored, i.e. nothing should happen");
    ...
    void getFileClientWithIdentifyTimeout() throws Exception {
        ...
        addFixture("Set the identification timeout to 2000ms");
        settingsForCUT.getRepositorySettings().getClientSettings()
                .setIdentificationTimeoutDuration(DatatypeFactory.newInstance().newDuration(2000));
    ...
    void conversationTimeout() throws Exception {
        addDescription("Tests the the GetFileClient handles lack of IdentifyPillarResponses gracefully  ");
        addStep("Set the number of pillars to 1 and a 1 second timeout for the conversation.", "");

        settingsForCUT.getRepositorySettings()
                      .getCollections()
                      .getCollection()
                      .getFirst()
                      .getPillarIDs()
        ...
        settingsForCUT.getRepositorySettings()
                      ...
                      .getPillarID()
                      .add(PILLAR1_ID);
        settingsForCUT.getReferenceSettings()
                      .getClientSettings()
                      .setConversationTimeout(DatatypeFactory.newInstance()
                                                             .newDuration(1000));
        GetFileClient client = createGetFileClient();
