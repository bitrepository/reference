 ...
 */
public class GetFileInfosClientTestWrapper implements GetFileInfosClient {
    private final GetFileInfosClient getFileInfosClientInstance;
    private final TestEventManager testEventManager;

    public GetFileInfosClientTestWrapper(GetFileInfosClient createGetFileInfosClient,
                                         TestEventManager testEventManager) {
        this.getFileInfosClientInstance = createGetFileInfosClient;
    ...
    public void getFileInfos(String collectionID, ContributorQuery[] contributorQueries, String fileID,
        ...
        getFileInfosClientInstance.getFileInfos(collectionID, contributorQueries, fileID, checksumSpec,
                addressForResult,
