...
public class ChecksumTest extends ExtendedTestCase {
    ...
    public void calculateChecksums() {
        ...
        Assert.assertEquals(ChecksumUtils.generateChecksum("", "md5", null), 
                "74e6f7298a9c2d168935f58c001bad88");
        Assert.assertEquals(ChecksumUtils.generateChecksum("", "sha1", null), 
                "fbdb1d1b18aa6c08324b7d64b71fb76370690e1d");
        Assert.assertEquals(ChecksumUtils.generateChecksum("", "sha256", null), 
        ...
        addStep("Test with the text '" + message + "' and key '" + key + "' for MD5, SHA1, and SHA256", 
                "Should give expected results.");
        Assert.assertEquals(ChecksumUtils.generateChecksum(message, "md5", key.getBytes()),
                "80070713463e7749b90c2dc24911e275");
        Assert.assertEquals(ChecksumUtils.generateChecksum(message, "sha1", key.getBytes()),
                "de7c9b85b8b78aa6bc8a7a36f70a90701c9db4d9");
        Assert.assertEquals(ChecksumUtils.generateChecksum(message, "sha256", key.getBytes()),
