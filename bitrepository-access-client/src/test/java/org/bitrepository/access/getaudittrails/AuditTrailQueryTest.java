...
public class AuditTrailQueryTest extends ExtendedTestCase {
    ...
    public void testNoSequenceNumbers() throws Exception {
        ...
        AuditTrailQuery query = new AuditTrailQuery(componentId, DEFAULT_MAX_NUMBER_OF_RESULTS);
    ...
    public void testOnlyMinSequenceNumber() throws Exception {
        ...
        Integer minSeq = 1;
        AuditTrailQuery query = new AuditTrailQuery(componentId, DEFAULT_MAX_NUMBER_OF_RESULTS, minSeq);
        Assert.assertEquals(query.getComponentID(), componentId);
    ...
    public void testBothSequenceNumberSuccess() throws Exception {
        ...
        Integer minSeq = 1;
        Integer maxSeq = 2;
        AuditTrailQuery query = new AuditTrailQuery(componentId, DEFAULT_MAX_NUMBER_OF_RESULTS, minSeq, maxSeq);
        Assert.assertEquals(query.getComponentID(), componentId);
        Assert.assertEquals(query.getMinSequenceNumber(), minSeq);
    ...
    public void testBothSequenceNumberFailure() throws Exception {
        ...
        Integer maxSeq = 1;
        try {
            new AuditTrailQuery(componentId, DEFAULT_MAX_NUMBER_OF_RESULTS, minSeq, maxSeq);
