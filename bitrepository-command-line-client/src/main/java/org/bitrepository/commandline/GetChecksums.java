...
public class GetChecksums {
    ...
    private void createOptionsForCmdArgumentHandler() {
        ...
        Option fileOption = new Option(Constants.FILE_ARG, true, "[OPTIONAL] The id for the file to retrieve the "
                + "checksum for. If no argument, then the checksum of all files are retrieved.");
        ...
        Option pillarOption = new Option(Constants.PILLAR_ARG, true, "[OPTIONAL] The id of the pillar where the "
                + "checksums should be retrieved from. If no argument, then the checksums will be retrieved from the "
                + "all pillars.");
