...
/**
 * Util class for handling formatting of data-sizes.
 */
public class FileSizeUtils {
    ...
    /*
     * Returns the appropriate unit for a given byte size. (e.g. MB or GB)
     *
     */
    ...
    /*
     *  Returns the number of bytes for a given unit (e.g. MB etc)
     */
