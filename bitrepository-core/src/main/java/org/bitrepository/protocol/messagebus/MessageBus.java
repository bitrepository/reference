...
public interface MessageBus extends MessageSender, AutoCloseable {
    ...
    /**
     * Closes the message bus connection so that everything can be shutdown nicely.
     *
    ...
    /**
     * @param componentIDs Defines the list of componentIDs with receiver component ID relevant for this message bus instance. If
