...
public class MessageSignerExceptionTest {
    ...
    public void testMessageSigningException() throws Exception {
        ...
        try {
            throw new MessageSigningException(errMsg);
        } catch(Exception e) {
            Assertions.assertInstanceOf(MessageSigningException.class, e);
        ...
        try {
            throw new MessageSigningException(errMsg, new IllegalArgumentException(causeMsg));
        } catch(Exception e) {
            Assertions.assertInstanceOf(MessageSigningException.class, e);
            Assertions.assertEquals(e.getMessage(), errMsg);
